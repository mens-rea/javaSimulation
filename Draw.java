...
public class Draw extends JComponent{
	...
	Vehicle[] monsters = new Vehicle[10];
	...
	public void spawnEnemy(){
		if(enemyCount < 10){
			monsters[enemyCount] = new Vehicle(randomizer.nextInt(500), randomizer.nextInt(500), this);
			enemyCount++;
		}
	}
	...
	public void paintComponent(Graphics g){
		...
		for(int c = 0; c < monsters.length; c++){		
			if(monsters[c]!=null){
				...
				g.fillOval(monsters[c].xPos, monsters[c].yPos, 20, 20);
			}	
		}
	}
